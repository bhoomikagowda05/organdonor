							  ...
							  <form name="form1" method="post" action="">
                                <table width="64%" height="249" border="0" align="center">
                                  <tr>
                                    ...
                                    <td width="83%" rowspan="6"><img src="images.jpg" width="275" height="183"></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><input  type="email" name="t4" id="t4" required="required" name="t2" type="text" id="t2"></td>
                                  </tr>
                                  <tr>
                                    <td><div align="right">Mobileno</div></td>
                                    <td>&nbsp;</td>
                                    <td><input title="only nos should be 10 digits" maxlength="10"   pattern="^\d{10}$" required name="t3" type="text" id="t3" maxlength="10"></td>
                                  </tr>
                                  <tr>
