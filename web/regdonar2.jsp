                                    ...
                                    <tr>
                                      ...
                                      <td width="629"><table width="116%" border="0" cellspacing="12" cellpadding="0">
                                          ...
                                          <tr>
                                            ...
                                            <td><input name="t17" type="text" id="t17" maxlength="10" pattern="[0-9]{10}" required="required"  /></td>
                                          </tr>
                                          <tr>
                                            <td>Gender</td>
                                            <td><label>
                                          ...
                                          <tr>
                                            ...
                                            <td><input name="t19" type="text" id="t19" maxlength="10" pattern="[0-9]{10}" required="required"  /></td>
                                          </tr>
                                          <tr>
                                            <td>State</td>
                                          ...
                                          <tr>
                                            <td>Pincode</td>
                                            <td><input name="t10" type="text" id="t10"pattern="[0-9]{6}" trequired="required" ></td>
