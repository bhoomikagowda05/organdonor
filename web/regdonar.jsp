		  ...
		  <tr>
			<td height="557" valign="top"><table width="920"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				<td height="39" class="menu"><table width="920"  border="0" cellspacing="0" cellpadding="0">
                  <tr align="center">
				   <td width="153"><a href="adminpage.jsp" id="linktop">Home </a></td>
...
<%@page import="java.util.*,java.io.*,javax.servlet.http.Cookie"%><%try
{
   Class.forName("com.mysql.jdbc.Driver");
     Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/organdonar","root","mysql"); 
 ...
 catch(Exception e)
    {
     ...
     out.println("Exception occured" +e);
                                          ...
                                          <td colspan="2"><div align="center" ><a href="selectloc.jsp"><strong><h4> Select Location On Map<h4> </strong></a></div></td>
                                          
                                          <tr>
                                            <td width="21%">First Name </td>
                                            <td width="25%"><input  type="text" id="t1" title="letters only" pattern="[A-Za-z]+" required="required"  name="t1" type="text" required="required" ></td>
                                          ...
                                          <tr>
                                            <td>Middle Name </td>
                                            <td><label>
                                            <input  type="text" id="t2" title="letters only" pattern="[A-Za-z]+" required="required"  name="t2" type="text"  required="required"  >
                                            </label></td>
                                            <td>Photo</td>
                                          ...
                                          <tr>
                                            <td>Last Name </td>
                                            <td><input  type="text" id="t3" title="letters only" pattern="[A-Za-z]+" required="required"  name="t3" type="text" required="required" ></td>
                                            <td>Adhar No </td>
          ...
          <input  name="t5"  id="t5" type="date"   type="text"  uib-datepicker-popup="{{dateformat}}" ng-model="dt" is-open="showdp" max-date="dtmax" />
          <span>
            <button type="button" class="btn btn-default" ng-click="showcalendar($event)"> <i class="glyphicon glyphicon-calendar"></i> </button>
                                            ...
                                            <td><input  name="t17" id="t17" title="only nos should be 10 digits" maxlength="10"   pattern="^\d{10}$" required="required"  type="text" maxlength="10"  required="required"  /></td>
                                          </tr>
                                          <tr>
                                            <td>Gender</td>
                                            <td><label>
                                          ...
                                          <tr>
                                            ...
                                            <td><input  title="only nos should be 10 digits" maxlength="10"   pattern="^\d{10}$" required="required" name="t19" id="t19" type="text"  maxlength="10"  required="required"  /></td>
                                          </tr>
                                          <tr>
                                            <td>State</td>
                        ...
                        <td><input  title="only nos should be 10 digits" maxlength="10"   pattern="^\d{10}$" required="required" name="t21" type="text" id="t21" maxlength="10"  required="required"  /></td>
                                          </tr>
                                          <tr>
                                            <td>Pincode</td>
